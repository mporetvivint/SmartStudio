...
import com.sunrun.leaguemediaassistant.GUI.BarcodeCaptureActivity;
...
public class CameraSource {
    ...
    private class FrameProcessingRunnable implements Runnable {
        ...
        @Override
        public void run() {
            //Setup firebase barcode reader
            FirebaseVisionBarcodeDetectorOptions options =
                    new FirebaseVisionBarcodeDetectorOptions.Builder()
                            .setBarcodeFormats(
                                    FirebaseVisionBarcode.FORMAT_QR_CODE)
                            .build();
            FirebaseVisionImage outputFrame;
...
//                            .build();
                    ...
                    outputFrame = FirebaseVisionImage.fromByteBuffer(data,metadata);
                    mPendingFrameData = null;
                }
                ...
                try {
                    Task<List<FirebaseVisionBarcode>> result = detector.detectInImage(outputFrame)
